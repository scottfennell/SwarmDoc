		...
		return {
			...
			*/
			...
			showAllPagesPanel : function(){
				...
				this.apPanel = new NotoAir.AllPagesPanel({"database":NotoAir.DB});
				console.log("AllPagesPanel",this.apPanel);
		    ...
		    showPageHistory: function(){
				...
				alert("showPageHistory - depreciated");
			...
			openPage: function(pname){
				...
				this.centerContainer.getLayout().setActiveItem(this.wikiPanel);
				this.wikiPanel.openPage(NotoAir.DB.getPage(pname));
				this.changePage();
			},
