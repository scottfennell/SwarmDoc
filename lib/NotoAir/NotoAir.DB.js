    ...
    return {
        ...
        init : function(){
		    ...
		    */
            ...
            console.log("Page and text tables created:",dbout, dbout2);
            ...
            this.database = new Ext.data.JsonReader({
                totalProperty: "results",             // The property which contains the total dataset size (optional)
                root: "page",                         // The property which contains an Array of row objects
        ...
        getPage : function(title){
            ...
            if(this.database != null){
                ...
                //if i am here, we didnt find the page
                var np = new NotoAir.Page({database:this});
                np.title = title;
                this.pages.push(np);
                //TODO update this to use event/listener
                if(this.npc != null){
                    this.npc(np);
                }
                return np;
        ...
        savePage : function(page){
            //take page and save it to the database
            /*
                Page reference 
            	this.body = '';
	            this.title = '';
