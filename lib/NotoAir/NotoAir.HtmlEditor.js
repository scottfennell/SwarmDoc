 ...
 * @author stillboy
 */
NotoAir.HTMLEditorStyles = function(cfg) {
  cfg = cfg || [];
...
// NotoAir.HTMLEditorToolbar
// extension of Ext.Toolbar to cater for extensibility
NotoAir.HTMLEditorToolbar = Ext.extend(Ext.Toolbar, {
  ...
  initComponent: function() {
    ...
    NotoAir.HTMLEditorToolbar.superclass.initComponent.call(this);
  ...
  onRender: function(ct, position) {
    ...
    // call Ext.Toolbar.onRender
   	NotoAir.HTMLEditorToolbarr.superclass.onRender.call(this, ct, position);
...
// NotoAir.HTMLEditorToolbar.ComboBox
// created to handle the pre-configuration of a combobox (pre-render)
NotoAir.HTMLEditorToolbar.ComboBox = function(config) {
  ...
  NotoAir.HTMLEditorToolbar.ComboBox.superclass.constructor.call(this, selEl);
  
}

// NotoAir.HTMLEditorToolbar.ComboBox
// extension of Ext.Toolbar.Item
Ext.extend(NotoAir.HTMLEditorToolbar.ComboBox, Ext.Toolbar.Item, {

  // overrides Ext.Toolbar.Item.render
  render: function(td) {
    
    // call Ext.Toolbar.Item.render
    NotoAir.HTMLEditorToolbar.ComboBox.superclass.render.call(this, td);
...
// register NotoAir.HTMLEditorToolbar.ComboBox as a new component
Ext.ComponentMgr.registerType('tbcombo', NotoAir.HTMLEditorToolbar.ComboBox);

// NotoAir.HTMLEditor
// extends Ext.form.HtmlEditor to provide extensibility
NotoAir.HTMLEditor = Ext.extend(Ext.form.HtmlEditor, {
  ...
  initComponent: function() {
    ...
    NotoAir.HTMLEditor.superclass.initComponent.call(this);
    ...
    this.tb = new NotoAir.HTMLEditorToolbar();
  ...
  onEditorEvent: function(e) {
    ...
    NotoAir.HTMLEditor.superclass.onEditorEvent.call(this, e);
