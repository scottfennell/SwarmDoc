 ...
 * @author stillboy
 * 
 * Html editor extentions to provide styles
 */
SwarmDoc.HTMLEditorStyles = function(cfg) {
  cfg = cfg || [];
...
// SwarmDoc.HTMLEditorToolbar
// extension of Ext.Toolbar to cater for extensibility
SwarmDoc.HTMLEditorToolbar = Ext.extend(Ext.Toolbar, {
  ...
  initComponent: function() {
    ...
    SwarmDoc.HTMLEditorToolbar.superclass.initComponent.call(this);
  ...
  onRender: function(ct, position) {
    ...
    // call Ext.Toolbar.onRender
   	SwarmDoc.HTMLEditorToolbarr.superclass.onRender.call(this, ct, position);
...
// SwarmDoc.HTMLEditorToolbar.ComboBox
// created to handle the pre-configuration of a combobox (pre-render)
SwarmDoc.HTMLEditorToolbar.ComboBox = function(config) {
  ...
  SwarmDoc.HTMLEditorToolbar.ComboBox.superclass.constructor.call(this, selEl);
  
}

// SwarmDoc.HTMLEditorToolbar.ComboBox
// extension of Ext.Toolbar.Item
Ext.extend(SwarmDoc.HTMLEditorToolbar.ComboBox, Ext.Toolbar.Item, {

  // overrides Ext.Toolbar.Item.render
  render: function(td) {
    
    // call Ext.Toolbar.Item.render
    SwarmDoc.HTMLEditorToolbar.ComboBox.superclass.render.call(this, td);
...
// register SwarmDoc.HTMLEditorToolbar.ComboBox as a new component
Ext.ComponentMgr.registerType('tbcombo', SwarmDoc.HTMLEditorToolbar.ComboBox);

// SwarmDoc.HTMLEditor
// extends Ext.form.HtmlEditor to provide extensibility
SwarmDoc.HTMLEditor = Ext.extend(Ext.form.HtmlEditor, {
  ...
  initComponent: function() {
    ...
    SwarmDoc.HTMLEditor.superclass.initComponent.call(this);
    ...
    this.tb = new SwarmDoc.HTMLEditorToolbar();
  ...
  onEditorEvent: function(e) {
    ...
    SwarmDoc.HTMLEditor.superclass.onEditorEvent.call(this, e);
